...
namespace Engine
{
    public class Player : LivingCreature
    {
        ...
        public List<InventoryItem> Inventory { get; set; } //these are lists. Keep them at the bottom of properties for readability
        ...
        public Player(int currentHitPoints, int maximumHitPoints, int gold, int experiencePoints, int level) : base(currentHitPoints, maximumHitPoints)
        {
            ...
            Inventory = new List<InventoryItem>(); // sets the lists to empty so can add objects. Otherwise it is equal to null. Cannot add objects to null lists
